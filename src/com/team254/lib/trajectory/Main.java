...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    final double kWheelbaseWidth = 25.5/12;
    {
      ...
      p.addWaypoint(new WaypointSequence.Waypoint(13.75, 1.0, Math.PI / 12.0));
    ...
    
    {
      ...
      p.addWaypoint(new WaypointSequence.Waypoint(0, 0, 0));
      p.addWaypoint(new WaypointSequence.Waypoint(7.0, 0, 0));
      p.addWaypoint(new WaypointSequence.Waypoint(13.75, 5.0, Math.PI / 12.0));
    ...
    
    {
      ...
      WaypointSequence p = new WaypointSequence(10);
      p.addWaypoint(new WaypointSequence.Waypoint(0, 0, 0));
      p.addWaypoint(new WaypointSequence.Waypoint(13.5, 0, 0));
